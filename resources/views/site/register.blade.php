...
<style>
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | V8 Registration corner alignment fix
    |--------------------------------------------------------------------------
    | De schuine polygon uit de kaart is weg.
    | De twee hoekaccenten zitten nu volledig BINNEN de form.
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Keep the motion, remove expensive animated blur
    |--------------------------------------------------------------------------
    */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    async function getPreciseLocation() {
        ...
        /*
         * Registratie mag nooit wachten op een nieuwe locatie-popup.
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                },
                {
                    enableHighAccuracy:
                        false,
                    timeout:
                        Math.min(1500, geolocationTimeout),
                    maximumAge:
                        Math.max(120000, geolocationMaximumAge),
                }
            );
        });
    }
    ...
    /*
    |--------------------------------------------------------------------------
    | Registration security context - non-blocking
    |--------------------------------------------------------------------------
    | Securitycontext wordt vooraf tijdens idle opgeslagen.
    | Formulieren en social login wachten niet meer op GPS/fetch.
    */
