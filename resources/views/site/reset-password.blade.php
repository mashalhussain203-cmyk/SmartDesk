...
<style>
    ...
    .oauth-alternatives-divider::before,
    .oauth-alternatives-divider::after {
        content: "";
        flex: 1;
        height: 1px;
        background: rgba(255,255,255,.07);
    ...
    .oauth-alt-button.facebook .oauth-alt-icon {
        background: #1877f2;
        color: #ffffff;
    }

    .oauth-alt-button.github .oauth-alt-icon svg {
        fill: currentColor;
    }
    ...
    <div class="new-password-stage">
        ...
        <div class="new-password-panel">
            ...
            <div class="new-password-shell">
                ...
                {{-- OAUTH ALTERNATIVES --}}
                <div class="oauth-alternatives">
                    <div class="oauth-alternatives-divider">
                        Of gebruik een gekoppeld account
                    </div>

                    <div class="oauth-alternatives-grid">
                        <a
                            class="oauth-alt-button google"
                            href="{{ route('google.redirect') }}"
                            aria-label="Doorgaan met Google"
                        >
                            <span class="oauth-alt-icon" aria-hidden="true">
                        ...
                        <a
                            class="oauth-alt-button facebook"
                            href="{{ route('facebook.redirect') }}"
                            aria-label="Doorgaan met Facebook"
                        >
                            <span class="oauth-alt-icon" aria-hidden="true">f</span>
                            Doorgaan met Facebook
                        </a>
                    </div>

                    <div class="oauth-alt-note">
                        Met OAuth hoef je geen Mashal-wachtwoord te delen.
                    </div>
                </div>
