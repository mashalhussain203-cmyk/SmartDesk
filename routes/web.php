...
Route::middleware('guest')->group(function () {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Bezoekers kunnen met een reeds gekoppeld X-account inloggen.
    |
    | De callback staat binnen de guest-groep. XAuthController controleert
    | daarnaast zelf OAuth state, PKCE en de maximale flowduur.
    |
    */
